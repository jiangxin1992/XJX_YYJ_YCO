...
- (void)setFrame:(CGRect)frame arrowOffset:(CGFloat)arrowOffset text:(NSString *)text
{
    ...
    self.layer.position = CGPointMake(CGRectGetMinX(frame) + CGRectGetWidth(frame)*anchorX, CGRectGetMinY(frame));
...
//    [popUpPath appendPath:arrowPath];
    ...
    CGFloat arrowTipX = CGRectGetMidX(rect) + arrowOffset;
    CGPoint tip = CGPointMake(arrowTipX, CGRectGetMaxY(rect));
    CGFloat arrowLength = ARROW_LENGTH;
    CGFloat x = ARROW_LENGTH;
    CGFloat maxX = CGRectGetMaxX(roundedRect);
    [popUpPath moveToPoint:tip];
    [popUpPath addLineToPoint:CGPointMake(MAX(arrowTipX - x, 0), CGRectGetMaxY(roundedRect) - arrowLength)];
    [popUpPath addLineToPoint:CGPointMake(0, CGRectGetMaxY(roundedRect) - arrowLength)];
    [popUpPath addLineToPoint:CGPointMake(0, CGRectGetMinY(roundedRect))];
    [popUpPath addLineToPoint:CGPointMake(maxX, CGRectGetMinY(roundedRect))];
    [popUpPath addLineToPoint:CGPointMake(maxX, CGRectGetMaxY(roundedRect) - arrowLength)];
    [popUpPath addLineToPoint:CGPointMake(MIN(arrowTipX + x, maxX), CGRectGetMaxY(roundedRect) - arrowLength)];
    [popUpPath closePath];
    return popUpPath;
}
