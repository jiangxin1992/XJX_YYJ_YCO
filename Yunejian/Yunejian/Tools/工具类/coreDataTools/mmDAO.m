...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSString *url = yyjDocumentsDirectory();
    url = [url stringByAppendingPathComponent:_dbFileName];
...
-(NSError*)reset{
    NSError *error;
    if(_mainObjectContext != nil && _bgObjectContext!=nil){
        [_bgObjectContext deletedObjects];
    }
    return error;
}
@end
