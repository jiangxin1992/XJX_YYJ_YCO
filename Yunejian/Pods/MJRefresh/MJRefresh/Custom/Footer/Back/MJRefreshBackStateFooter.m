...
- (void)prepare
{
    ...
    [self setTitle:NSLocalizedString(@"上拉可以加载更多数据",nil) forState:MJRefreshStateIdle];
    [self setTitle:NSLocalizedString(@"松开立即加载更多数据",nil) forState:MJRefreshStatePulling];
    [self setTitle:NSLocalizedString(@"加载数据中...",nil) forState:MJRefreshStateRefreshing];
    [self setTitle:NSLocalizedString(@"已经全部加载完毕",nil) forState:MJRefreshStateNoMoreData];
}
